...
export default function MainSc({navigation}) {
    return (
        <View style={styles.container}>
            ...
            <FillButton title={'Weight'} onPress={() => {navigation.navigate("DashBoard");}}/>
            </View>
            <View style={styles.title}>
            <FillButton title={'DashBoard'} onPress={() => {navigation.navigate("DashBoard2");}}/>
            <FillButton title={'history'} onPress={() => {navigation.navigate("history");}}/>
            </View>
            <View>
