...
#define WIFI_SSID "Que"
#define WIFI_PASSWORD "774123456"

String GOOGLE_SCRIPT_ID = "AKfycbxqMBCPK0zCzjGHnHYs6bydaIf-zkPhR3lpoxgDbe5beVVURpo";
...
void loop(){
    ...
    if(Firebase.push(firebaseData, "/Temp",sensors.getTempCByIndex(0)))
    {
...
/*
  ...
  */
  //gg sheet
    sendData("Turbidity=" +String(ntu)+"&temp="+String(sensors.getTempCByIndex(0)));
